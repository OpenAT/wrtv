...
(function () {
    ...
    openerp.website.RTE = openerp.website.RTE.extend({
        _config: function () {
            ...
            config.colorButton_colors = 'ffffff,000000,dd710f,736664,f6d6b7';
            ...
            config.stylesSet = [
                ...
                {name: 'p Klein', element: 'p', attributes: { 'class': 'wrtv_small' } },
                {name: 'p Winzig', element: 'p', attributes: { 'class': 'wrtv_tiny' } },
                ...
                // {name: 'Klein', element: 'span', attributes: { 'class': 'wrtv_small_text' } },
                // {name: 'Sehr-Klein', element: 'span', attributes: { 'class': 'wrtv_very_small_text' } },
            ];
